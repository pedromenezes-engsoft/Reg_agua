...
import 'package:my_water_app/blocs/leitura_bloc/leitura_event.dart';
import 'package:my_water_app/blocs/leitura_bloc/leitura_state.dart';
...
import 'package:my_water_app/utils/mixins/convert_currency.dart';
import 'package:my_water_app/utils/mixins/convert_file.dart';
import 'package:my_water_app/utils/mixins/date_formate.dart';
...
class _HomePageState extends State<HomePage>
  ...
  final valorTotalMc = ValueNotifier(0);
          ...
          child: BlocListener<LeituraBloc, LeituraState>(
            ...
            listener: (context, state) {
              if (state is LeituraStateLoaded) {
                ...
                final (valorTotal: _valorTotal, valorTotalMc: _valorTotalMc) =
                    leituras.calcularFaturaTotal();

                this.leituras = leituras;

                valorTotal.value = _valorTotal;
                valorTotalMc.value = _valorTotalMc;
              }
            },
            child: Form(
              key: formKey,
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: AnimatedBuilder(
                          animation:
                              Listenable.merge([valorTotal, valorTotalMc]),
                            ...
                            return SizedBox(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Total m3: ${valorTotalMc.value}',
                                    key: const Key('valor_total_Mc'),
                                    style: textTheme.labelMedium,
                                    textAlign: TextAlign.start,
                                  ),
                                ],
                      ...
                      TextFormField(
                        ...
                        decoration: const InputDecoration(
                          ...
                          label: Text('valor total de m3'),
                          hintText: 'Adicione o valor total de m3 do relógio',
                        ),
                      ),
                      const SizedBox(
                        height: 24,
                              ...
                              children: [
                                ...leituras.leituras.asMap().entries.map(
                                  (entry) {
                                    ...
                                    final value = leitura.calcularValorMc(
